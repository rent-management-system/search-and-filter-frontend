          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            ...
            <TabsContent value="all" className="space-y-8">
              <div className="text-center mb-6 px-4">
                <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                  {t('index.all_approved_properties')}
                </h3>
                <p className="text-sm md:text-base lg:text-lg text-muted-foreground max-w-2xl mx-auto">
                  {t('index.browse_our_complete_collection')}
                </p>
              </div>
